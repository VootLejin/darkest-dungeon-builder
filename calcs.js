...
function create_monster_list(cr, count, monster_list) {
    for(var i = 0; i < count; i++){
        ...
        var monster_index =  Math.floor(Math.random() * cr_list.length+1);
        li.innerText = cr_list[monster_index];
...
for (var i = 0; i < monsters.length; i++){
    ...
    var cr = monster["Challenge"].trim();
    if (!(cr in cr_to_monster)){
        cr_to_monster[cr] = [];
    }
    console.log(monster["name"]);
    cr_to_monster[cr].push(monster["name"]);
